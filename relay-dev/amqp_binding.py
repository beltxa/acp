...
class RelayAmqpPublisher:
    ...
    def publish(
        ...
        *,
        ...
        queue_name = self._pick(amqp_service, "queue", queue_name_for_agent(recipient))
        routing_key = self._pick(amqp_service, "routing_key", routing_key_for_agent(recipient))
