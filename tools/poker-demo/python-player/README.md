...
This service implements the ACP poker player runtime in Python with the same ACP message flow as the Java player:
...
python tools/poker-demo/python-player/app.py
```
