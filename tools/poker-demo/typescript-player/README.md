# Poker TypeScript Player

This service implements the ACP poker player runtime in TypeScript with the same ACP message flow as the Java player:
...
cd ../../tools/poker-demo/typescript-player
npm install
npm run build
npm run start
```
